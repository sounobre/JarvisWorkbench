...
1. JW-001 — Criar projeto Spring Boot base.
2. JW-002 — Configurar PostgreSQL e Flyway.
3. JW-003 — Padronizar resposta de erro.

## Sprint 1 — Jobs

1. JW-010 — Criar entidade Job.
2. JW-011 — Criar endpoint para iniciar job.
3. JW-012 — Consultar job por ID público.
4. JW-013 — Listar jobs com filtros e paginação.

## Sprint 2 — Ciclo de vida de jobs

1. JW-014 — Atualizar progresso do job.
2. JW-015 — Finalizar job com sucesso.
3. JW-016 — Finalizar job com erro.

## Sprint 3 — Documentos

1. JW-020 — Upload de arquivo TXT/Markdown.
2. JW-021 — Listar documentos importados.
3. JW-022 — Consultar detalhe de documento.

## Sprint 4 — Segmentação

1. JW-030 — Criar job de segmentação por parágrafos.
2. JW-031 — Consultar parágrafos de um documento.
3. JW-032 — Criar segmentação por sentenças.

## Sprint 5 — Bilíngue básico

1. JW-040 — Criar entidade DocumentPair.
2. JW-041 — Alinhamento baseline por índice.
3. JW-042 — Calcular heurística de tamanho do par.

## Sprint 6 — Memória

1. JW-050 — Aprovar par alinhado para memória.
2. JW-051 — Buscar memória por texto simples.
3. JW-052 — Preparar estrutura para embeddings.

## Sprint 7 — IA local

1. JW-060 — Criar client HTTP para modelo local.
2. JW-061 — Criar endpoint de teste de prompt.

## Sprint 8 — Frontend

1. JW-070 — Criar aplicação React base.
2. JW-071 — Tela de listagem de jobs.
3. JW-072 — Tela de detalhe do job.

## Sprint 9 — Apresentação profissional

1. JW-080 — Criar README profissional.
2. JW-081 — Criar coleção Postman ou arquivo HTTP.
3. JW-082 — Criar testes principais de integração.

---

# Como você deve me pedir ajuda durante o desenvolvimento

## Para implementar uma estória

Use este formato:

```text
Amigo, vamos desenvolver a estória JW-011.
Meu projeto está assim: [cole estrutura ou arquivos relevantes].
Quero que você gere o código no formato Component-First, com comentários e explicando cada parte.
```
...
```text
Amigo, faz code review da estória JW-011.
Vou colar os arquivos alterados.
Quero que você veja: arquitetura, bugs, boas práticas, testes e se atende os critérios de aceite.
```
...
```text
Amigo, estou na estória JW-011 e deu esse erro:
...
```text
Amigo, na estória JW-014 fiquei em dúvida se essa regra deve ficar no service, entity ou outro lugar.
Me explica como LT/arquiteto e me dá a recomendação.
```
...
Comece pela **JW-001 — Criar projeto Spring Boot base**.

Não pule para IA ainda. A base profissional vem primeiro.
...
Quando terminar, peça code review da JW-001 antes de ir para JW-002.
